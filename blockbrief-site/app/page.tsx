      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 pb-10 pt-6 sm:px-6 lg:px-8">
        ...
        <nav className="mb-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-sky-500 via-emerald-400 to-cyan-300 text-xs font-bold tracking-tight">
              BB
            </div>
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-[11px] text-slate-500">
                Crypto news, alpha & risk in plain language.
              </span>
            </div>
          </div>

          <div className="hidden items-center gap-6 text-xs text-slate-400 md:flex">
            <button className="hover:text-slate-100">Daily Briefs</button>
            <button className="hover:text-slate-100">Signals</button>
            <button className="hover:text-slate-100">Market Intel</button>
            <button className="hover:text-slate-100">Dashboards</button>
            <button className="hover:text-slate-100">About</button>
          </div>

          <div className="flex items-center gap-3 text-xs">
            <button className="rounded-full border border-slate-700/70 bg-black/40 px-3 py-1 text-slate-300 hover:border-slate-400">
              Login
            </button>
            <button className="rounded-full bg-sky-500 px-4 py-1.5 font-semibold text-black shadow-lg shadow-sky-500/30 hover:bg-sky-400">
              Join Free
            </button>
          </div>
        </nav>
        ...
        {/* Hero */}
        <section className="mt-10 grid gap-10 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] lg:items-start">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base text-slate-300 sm:text-lg">
              BlockBrief scans the chaos — charts, chains, funds, and rumors —
              and sends you a clean, readable summary twice a day. Warnings
              included. Alpha included. Drama filtered.
            </p>
            ...
            <div className="mt-8 w-full max-w-xl">
              <div className="gradient-border rounded-3xl">
                <div className="relative rounded-3xl bg-zinc-950/70 p-5 shadow-xl backdrop-blur">
                  <form
                    action="https://formspree.io/f/mrbnzavb"
                    method="POST"
                  ...
                  <p className="mt-3 text-xs text-slate-500">
                    No spam. Just the daily crypto download and occasional alpha
          ...
          <aside className="lg:mt-3">
            <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-zinc-900/90 to-black/95 p-4 shadow-2xl shadow-black/60 backdrop-blur">
              ...
              <p className="mt-2 text-xs text-slate-400">
                Here’s how the last 24 hours actually mattered — without
                screenshots of PnL.
              </p>
              ...
              <div className="mt-4 rounded-2xl border border-amber-500/40 bg-amber-500/5 p-3">
                ...
                <p className="mt-1 text-xs text-amber-100/80">
                  We’ll tell you when a project gets halted, exploited, or
                  quietly rugged — and what it might mean for your bags.
                </p>
              </div>
        ...
        <section className="mt-10">
          <div className="mb-3 flex items-center justify-between gap-2">
            ...
            <span className="text-[11px] text-slate-500">
              Live data coming soon · values are placeholders
            </span>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {marketIntel.map((item) => (
              <div
                key={item.label}
                className="rounded-2xl border border-white/5 bg-zinc-950/70 p-4 text-xs"
              >
        ...
        {/* Issue #000 template */}
        <section className="mt-10 rounded-3xl border border-white/5 bg-black/40 p-4 sm:p-5">
          <div className="flex items-center justify-between gap-2">
            <h2 className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">
              Issue #000 · Wireframe
            </h2>
            <span className="text-[11px] text-slate-500">
              Use this as your daily outline.
            </span>
          </div>

          <div className="mt-3 grid gap-4 text-xs sm:grid-cols-3">
            <div className="space-y-1">
              <p className="font-semibold text-slate-200">1. Top 5 Things</p>
              <p className="text-slate-400">
                • Macro / BTC move{" "}
                <br />
                • Biggest narrative shift
                <br />
                • One key funding / launch
                <br />
                • One risk event
                <br />
                • One “builders are shipping” item
              </p>
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-400">
                One project, mechanism, or behavior that looks dangerous.
              </p>
              <p className="mt-2 font-semibold text-slate-200">
                5. Boost Quote / Closing Line
              </p>
              <p className="text-slate-400">
                One sentence from Boost that leaves the reader focused and ready
        ...
        <footer className="mt-10 border-t border-white/5 pt-4 text-xs text-slate-500">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <span>
              © {new Date().getFullYear()} BlockBrief. All signals. No spam.
            </span>
